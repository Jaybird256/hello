        ...
        stage ('Deploy') {
            ...
            steps {
                sshagent(credentials: ['cloudlab']) {
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no Jbird256@155.98.33.74 kubectl apply -f /users/lngo/deployment.yml -n jenkins'
                    sh 'ssh -o StrictHostKeyChecking=no Jbird256@155.98.33.74 kubectl apply -f /users/lngo/service.yml -n jenkins'                                        
                }
            }
        }
    }
